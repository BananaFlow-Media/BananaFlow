...
_ALLOWED = {
    ("ui/panels/metadata_editor/io_dialog.py", 403, "HTML"),
    ("ui/panels/metadata_editor/io_dialog.py", 403, "CSV"),
    ("ui/panels/metadata_editor/io_dialog.py", 405, "English"),
    ("ui/panels/metadata_editor/io_dialog.py", 471, "M3U8"),
    ("ui/panels/metadata_editor/io_dialog.py", 471, "M3U"),
}
