...
class TestRetryDownload:
    ...
    @pytest.mark.parametrize("earlier_evidence", [
        "WARNING: Unable to fetch GVS PO Token",
        "WARNING: YouTube account cookies are no longer valid",
        "ERROR: Sign in to confirm you're not a bot",
    ])
    def test_permanent_extractor_evidence_outranks_later_transfer_403(
        self, earlier_evidence,
    ):
