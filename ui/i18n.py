...
_TAG_EDITOR_SHELL_TEXTS_EN = {
    ...
    "meta_apply_value_group": "Set one value across the selection",
    "meta_apply_value_note": "Applies to the selected rows only, as a pending change.",
    "meta_apply_artist_to_selection": "Set artist",
    "meta_apply_album_to_selection": "Set album",
...
_TAG_EDITOR_SHELL_TEXTS_HE = {
    ...
    "meta_apply_value_group": "קביעת ערך אחד לכל הבחירה",
    "meta_apply_value_note": "חל על השורות שנבחרו בלבד, כשינוי ממתין.",
    "meta_apply_artist_to_selection": "קבע אמן",
    "meta_apply_album_to_selection": "קבע אלבום",
