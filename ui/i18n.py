...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    "en": {
        ...
        "touch_density": "Touch-Friendly Sizing",
        "touch_density_desc": "Enlarge buttons, fields and scrollbars to finger-sized targets — applies immediately. Touch scrolling and press-and-hold menus work without this.",
        ...
        "meta_auto_settings_title": "Auto Arrange Settings",
        "meta_clean_settings_title": "Clean-up Settings (aggressive)",
        "meta_auto_header": "Choose which additional actions Auto Arrange will perform:",
        "meta_auto_album_note": "Auto Arrange always derives the title and track number from the filename and the album from the folder name. The options below run afterward.",
        ...
        "meta_op_title_strip_label": "Title from filename - remove numbering",
        ...
        "meta_op_strip_junk_label": "Remove unwanted extras from title",
        ...
        "meta_op_rename_from_title_label": "Rename physical file to match the title",
        "meta_op_rename_from_title_desc": "Renames the file on disk so its name matches the Title tag. Like every other operation this only creates a proposal; nothing is renamed before Apply.",
        # These three take parameters, so their labels end with an ellipsis:
        # they open the action engine on that action instead of running at once.
        "meta_op_replace_text_label": "Find and replace in a field…",
        "meta_op_replace_text_desc": "Replaces text inside one tag field across the selection, with a full preview before anything is proposed.",
        "meta_op_change_case_label": "Change letter case…",
        "meta_op_change_case_desc": "Converts one field to UPPERCASE, lowercase, Title Case or Sentence case.",
        "meta_op_number_tracks_label": "Number tracks automatically…",
        "meta_op_number_tracks_desc": "Fills the track number for the selection in table order, from a starting number and step you choose.",

        # ── Tag Editor: inspector rail group titles ─────────────────────────────
        "meta_group_from_filename": "From Filename",
        "meta_group_cleanup": "Clean Up & Clear",
        ...
        "meta_duplicates_tools_title": "Duplicates",
        ...
        "meta_auto_cfg_tooltip": "Configure what Auto Arrange will perform",
        "meta_auto_configure_actions": "Configure which actions run",
        ...
        "meta_edit_tags_group": "Fields",
        "meta_inspector_no_selection_title": "Select rows to edit",
        "meta_inspector_no_selection_header": "No selection",
        ...
        "meta_inspector_lyrics_section": "Lyrics",
        ...
        "meta_artwork_choose_image": "Choose image",
        "meta_artwork_proposal_note": "Artwork changes are added as proposals and are written only by the final Apply action.",
        "meta_artwork_support_note": "JPEG and PNG artwork is supported. Animated GIF files are not embedded.",
        "meta_artwork_none_short": "No cover",
        "meta_artwork_mixed_short": "Different covers",
        "meta_artwork_drop_prompt": "Drop a JPEG or PNG here",
        "meta_inspector_replaygain_section": "ReplayGain",
        "meta_inspector_file_properties_section": "File Properties",
        ...
        "meta_fields_scope_note": "This edit applies only to the rows selected in the table. A field you haven't touched will not change.",
        ...
        "meta_lyrics_editor_note": "An empty editor does not clear lyrics. Clearing requires an explicit action.",
        ...
        "meta_replaygain_propose_clear": "Propose clear",
        "meta_replaygain_album_note": "Album analysis requires consistent album identity. Ambiguous files receive track values only.",
        ...
        "meta_property_capability": "Capability",
        "meta_property_capability_full": "Tags + artwork + rename",
        "meta_property_open": "Open",
        "meta_property_reveal": "Show in folder",
        "meta_property_copy_path": "Copy path",
        ...
        "meta_mixed_placeholder": "mixed values",
        ...
        "meta_apply_to_selection": "Add to Pending Changes",
        ...
        "mt_col_status":       "State",
        "mt_status_pending_changes": "{n} pending",
        "mt_status_read_only":       "Read-only",
        ...
        "md_auto_changes_proposed": "Auto Arrange: {n} changes proposed",
        "md_auto_no_changes": "Auto Arrange: all files are already organised",
        ...
        "md_recovery_forget_unresolved_warning": "The state of {n} file(s) could not be automatically verified (see Show Details). Forgetting now permanently discards the only record that could restore their original tags and filename — there is no automatic way back afterward.",
    ...
    "he": {
        ...
        "card_move_up": "העבר למעלה",
        "card_move_down": "העבר למטה",
        "touch_density": "התאמת גודל למגע",
        "touch_density_desc": "הגדלת כפתורים, שדות ופסי גלילה למידה שנוחה לאצבע — נכנס לתוקף מיד. גלילה במגע ותפריטים בלחיצה ארוכה פועלים גם בלי זה.",
        ...
        # ── Tag Editor: dialogs / headers ───────────────────────────────────────
        "meta_auto_settings_title": "הגדרות סידור אוטומטי",
        "meta_clean_settings_title": "הגדרות ניקוי (אגרסיביות)",
        "meta_auto_header": "בחר אילו פעולות נוספות יבצע הסידור האוטומטי:",
        "meta_auto_album_note": "הסידור האוטומטי תמיד מפיק כותרת ומספר רצועה משם הקובץ ואלבום משם התיקייה. האפשרויות למטה רצות לאחר מכן.",
        "meta_clean_title_group": "ניקוי כותרת (Title)",
        "meta_clean_filename_group": "ניקוי שם קובץ פיזי (Filename)",

        # ── Tag Editor: auto-order operations ───────────────────────────────────
        "meta_op_title_strip_label": "כותרת משם הקובץ - הסר מספור",
        ...
        "meta_op_rename_from_title_label": "שנה שם קובץ פיזי לפי הכותרת",
        "meta_op_rename_from_title_desc": "משנה את שם הקובץ בדיסק כך שיתאים לתגית הכותרת. כמו כל פעולה אחרת גם זו יוצרת הצעה בלבד; שום קובץ לא משנה את שמו לפני ההחלה.",
        # שלוש הפעולות הבאות מקבלות פרמטרים, ולכן התווית שלהן מסתיימת בשלוש
        # נקודות: הן פותחות את מנוע הפעולות על הפעולה הזו במקום לרוץ מיד.
        "meta_op_replace_text_label": "חיפוש והחלפה בשדה…",
        "meta_op_replace_text_desc": "מחליף טקסט בתוך שדה תגית אחד בכל הבחירה, עם תצוגה מקדימה מלאה לפני שנוצרת הצעה.",
        "meta_op_change_case_label": "שינוי אותיות גדולות וקטנות…",
        "meta_op_change_case_desc": "ממיר שדה אחד לאותיות גדולות, קטנות, אות ראשונה גדולה בכל מילה או אות ראשונה גדולה במשפט.",
        "meta_op_number_tracks_label": "מספור רצועות אוטומטי…",
        "meta_op_number_tracks_desc": "ממלא את מספר הרצועה לכל הבחירה לפי סדר השורות בטבלה, החל ממספר התחלה וקפיצה שתבחרו.",

        # ── Tag Editor: inspector rail group titles ─────────────────────────────
        "meta_group_from_filename": "לפי שם הקובץ",
        "meta_group_cleanup": "ניקוי ומחיקה",
        ...
        "meta_duplicates_tools_title": "כפילויות",
        ...
        "meta_auto_cfg_tooltip": "הגדר מה הסידור האוטומטי יבצע",
        ...
        "meta_edit_tags_group": "שדות",
        "meta_inspector_no_selection_title": "בחר שורות לעריכה",
        "meta_inspector_no_selection_header": "אין בחירה",
        ...
        "meta_inspector_lyrics_section": "מילות שיר",
        ...
        "meta_inspector_replaygain_section": "ReplayGain",
        "meta_inspector_file_properties_section": "מאפייני קובץ",
        ...
        "meta_fields_scope_note": "עריכה זו חלה רק על השורות שנבחרו בטבלה. שדה שלא נגעתם בו לא ישתנה.",
        ...
        "mt_col_status":       "מצב",
        "mt_status_pending_changes": "{n} ממתינים",
        "mt_status_read_only":       "קריאה בלבד",
        ...
        "md_auto_changes_proposed": "סידור אוטומטי: {n} שינויים הוצעו",
        "md_auto_no_changes": "סידור אוטומטי: כל הקבצים כבר מסודרים",
        ...
        "md_recovery_forget_unresolved_warning": "לא ניתן היה לאמת אוטומטית את מצבם של {n} קבצים (ראה/י הצג פרטים). שכיחה כעת תמחק לצמיתות את הרישום היחיד שיכול היה להחזיר להם את התגיות ואת שם הקובץ המקוריים — לא תהיה דרך אוטומטית לחזור אחורה.",
...
_TAG_ACTION_TEXTS_EN = {
    "meta_action_engine_title": "All Actions",
    ...
    "meta_action_engine_open": "Open All Actions",
    "meta_all_actions_page_body": "Run a common action directly, or open the complete engine, templates, and saved workflows. Every change remains a preview until it is added to Pending Changes.",
    "meta_all_actions_common_heading": "Common Actions",
    "meta_all_actions_engine_heading": "Complete Action Engine",
    "meta_all_actions_engine_body": "Choose from every built-in action, scope it precisely, configure its parameters, and preview the result.",
    "meta_all_actions_engine_open": "Open Complete Action Engine",
    "meta_all_actions_templates_heading": "Templates",
    "meta_all_actions_templates_body": "Parse filenames into tags or build filenames from tags with reusable patterns.",
    "meta_all_actions_templates_open": "Open Templates",
    "meta_all_actions_workflows_heading": "Saved Workflows",
    "meta_all_actions_workflows_body": "Run, create, rename, duplicate, import, export, or remove reusable action workflows.",
    "meta_all_actions_workflows_open": "Open Saved Workflows",
    "meta_action_kind_accessible": "Action type",
    "meta_actions_tab": "Actions",
    "meta_templates_tab": "Templates",
    "meta_presets_tab": "Saved Workflows",
    ...
    "meta_action_repair_encoding": "Repair garbled text (wrong encoding)",
    "meta_action_repair_encoding_desc": "Recovers Hebrew or other non-Latin text that older software stored under a legacy code page, which reads back as gibberish. Files whose text is already correct are left untouched.",
    "meta_action_replace_regex": "Find and replace with a regular expression",
    "meta_action_replace_regex_desc": "Replace text in a field using a regular expression. Capture groups are available in the replacement as \\1, \\2 and so on. An invalid pattern is reported per file and never stops the preview.",
    "meta_action_split_field": "Split a field on a separator",
    "meta_action_split_field_desc": "Splits a field at the first occurrence of a separator and moves the second half into another field, for example 'Artist - Title' in the Title field. A file without the separator is left untouched.",
    ...
    "meta_action_param_pattern": "Regular expression",
    "meta_action_param_separator": "Separator",
    "meta_action_param_target_field": "Move second half to",
    "meta_action_param_target_first": "Keep the second half instead",
    "meta_action_param_codepage": "Original encoding",
    "meta_action_param_all_fields": "Repair every text field",
    "meta_action_diag_invalid_pattern": "The regular expression is not valid.",
    "meta_action_diag_empty_half": "Splitting here would leave one of the two fields empty.",
    "meta_action_diag_nothing_to_repair": "This file's text is already correct for that encoding.",
    ...
    "meta_preset_save_as": "Save as workflow",
    ...
    "meta_preset_name_prompt": "Workflow name",
    "meta_preset_copy_name": "{name} copy",
    "meta_preset_delete_confirm": "Delete the custom workflow “{name}”?",
    "meta_preset_saved": "Custom workflows saved.",
    "meta_preset_store_corrupt": "The custom workflow file is damaged. Built-in workflows are still available.",
    "meta_preset_store_unsupported": "This workflow file uses an unsupported schema. Built-in workflows are still available.",
    "meta_preset_store_migrated": "Older custom workflows were loaded and will be upgraded on the next save.",
...
_TAG_ACTION_TEXTS_HE = {
    "meta_action_engine_title": "כל הפעולות",
    ...
    "meta_action_engine_open": "פתיחת כל הפעולות",
    "meta_all_actions_page_body": "אפשר להריץ פעולה נפוצה ישירות, או לפתוח את המנוע המלא, תבניות ותהליכים שמורים. כל שינוי נשאר בתצוגה מקדימה עד להוספתו לשינויים הממתינים.",
    "meta_all_actions_common_heading": "פעולות נפוצות",
    "meta_all_actions_engine_heading": "מנוע הפעולות המלא",
    "meta_all_actions_engine_body": "בחירת כל פעולה מובנית, הגדרת הטווח והפרמטרים שלה ותצוגה מקדימה של התוצאה.",
    "meta_all_actions_engine_open": "פתיחת מנוע הפעולות המלא",
    "meta_all_actions_templates_heading": "תבניות",
    "meta_all_actions_templates_body": "פענוח שמות קבצים לתגיות או יצירת שמות קבצים מתגיות באמצעות תבניות לשימוש חוזר.",
    "meta_all_actions_templates_open": "פתיחת תבניות",
    "meta_all_actions_workflows_heading": "תהליכים שמורים",
    "meta_all_actions_workflows_body": "הרצה, יצירה, שינוי שם, שכפול, ייבוא, ייצוא או מחיקה של תהליכי פעולות לשימוש חוזר.",
    "meta_all_actions_workflows_open": "פתיחת תהליכים שמורים",
    "meta_action_kind_accessible": "סוג פעולה",
    "meta_actions_tab": "פעולות",
    "meta_templates_tab": "תבניות",
    "meta_presets_tab": "תהליכים שמורים",
    ...
    "meta_action_repair_encoding": "תיקון טקסט משובש (קידוד שגוי)",
    "meta_action_repair_encoding_desc": "משחזר טקסט בעברית או בשפה אחרת שתוכנה ישנה שמרה בקידוד מקומי, ולכן נקרא כג'יבריש. קבצים שהטקסט בהם כבר תקין נשארים ללא שינוי.",
    "meta_action_replace_regex": "חיפוש והחלפה עם ביטוי רגולרי",
    "meta_action_replace_regex_desc": "מחליף טקסט בשדה באמצעות ביטוי רגולרי. אפשר להשתמש בקבוצות לכידה בהחלפה בעזרת \\1, \\2 וכן הלאה. תבנית שגויה מדווחת לכל קובץ בנפרד ואינה עוצרת את התצוגה המקדימה.",
    "meta_action_split_field": "פיצול שדה לפי מפריד",
    "meta_action_split_field_desc": "מפצל שדה במופע הראשון של מפריד ומעביר את החצי השני לשדה אחר, למשל 'אמן - כותרת' בשדה הכותרת. קובץ שאין בו את המפריד נשאר ללא שינוי.",
    ...
    "meta_action_param_pattern": "ביטוי רגולרי",
    "meta_action_param_separator": "מפריד",
    "meta_action_param_target_field": "העבר את החצי השני אל",
    "meta_action_param_target_first": "השאר את החצי השני במקום",
    "meta_action_param_codepage": "הקידוד המקורי",
    "meta_action_param_all_fields": "תקן את כל שדות הטקסט",
    "meta_action_diag_invalid_pattern": "הביטוי הרגולרי אינו תקין.",
    "meta_action_diag_empty_half": "פיצול כאן היה משאיר את אחד משני השדות ריק.",
    "meta_action_diag_nothing_to_repair": "הטקסט בקובץ הזה כבר תקין עבור הקידוד הזה.",
    ...
    "meta_preset_save_as": "שמירה כתהליך",
    ...
    "meta_preset_name_prompt": "שם התהליך",
    "meta_preset_copy_name": "עותק של {name}",
    "meta_preset_delete_confirm": "למחוק את התהליך המותאם „{name}” ?",
    "meta_preset_saved": "התהליכים המותאמים נשמרו.",
    "meta_preset_store_corrupt": "קובץ התהליכים המותאמים פגום. התהליכים המובנים עדיין זמינים.",
    "meta_preset_store_unsupported": "קובץ התהליכים משתמש בסכימה שאינה נתמכת. התהליכים המובנים עדיין זמינים.",
    "meta_preset_store_migrated": "תהליכים ישנים נטענו וישודרגו בשמירה הבאה.",
...
_METADATA_IO_TEXTS_EN = {
    ...
    "meta_io_subtitle": "Exchange metadata, reports, playlists, and custom workflows through explicit previews.",
    ...
    "meta_io_export_presets": "Export Saved Workflows",
    "meta_io_import_presets": "Import Saved Workflows",
    ...
    "meta_io_preset_package": "Portable custom-workflow package",
    "meta_io_scope": "Scope",
    ...
    "meta_io_conflict_replace": "Replace the same custom workflow",
    "meta_io_conflict_rename": "Import as a renamed custom workflow",
    "meta_io_preset_name": "Workflow name",
    ...
    "meta_io_preset_selection": "Custom workflows to export", "meta_io_preset_transfer": "Import / Export Saved Workflows",
    "meta_io_rename_to": "Rename to", "meta_io_validate_package": "Validate Package",
    "meta_io_accept_preset_import": "Import Valid Workflows", "meta_io_preset_preview_ready": "Validated {n} workflow entries. Review each conflict before import.",
    "meta_io_details": "Details",
    "meta_io_preset_preview": "Workflow transfer validation preview",
    ...
    "meta_io_preset_import_success": "Imported {n} custom workflows; skipped {skipped}.",
...
_METADATA_IO_TEXTS_HE = {
    **_METADATA_IO_TEXTS_EN,
    ...
    "meta_io_subtitle": "החלפת מטא־דאטה, דוחות, רשימות השמעה ותהליכים שמורים מותאמים — רק לאחר תצוגה מקדימה מפורשת.",
    ...
    "meta_io_export_playlist": "ייצוא רשימת השמעה", "meta_io_export_presets": "ייצוא תהליכים שמורים",
    "meta_io_import_presets": "ייבוא תהליכים שמורים",
    ...
    "meta_io_playlist_options": "טווח רשימת ההשמעה, סדר, נתיבים ותבנית", "meta_io_preset_package": "חבילת תהליכים שמורים מותאמת וניידת",
    ...
    "meta_io_conflict_keep_both": "שמירת שניהם עם מזהה חדש", "meta_io_conflict_replace": "החלפת אותו תהליך מותאם",
    "meta_io_conflict_rename": "ייבוא כתהליך מותאם בשם אחר", "meta_io_preset_name": "שם התהליך",
    ...
    "meta_io_preset_selection": "תהליכים מותאמים לייצוא", "meta_io_preset_transfer": "ייבוא / ייצוא תהליכים שמורים",
    "meta_io_rename_to": "שינוי שם אל", "meta_io_validate_package": "אימות החבילה",
    "meta_io_accept_preset_import": "ייבוא תהליכים תקינים", "meta_io_preset_preview_ready": "אומתו {n} תהליכים. יש לבדוק כל התנגשות לפני הייבוא.",
    "meta_io_details": "פרטים", "meta_io_preset_preview": "תצוגת אימות להעברת תהליכים שמורים",
    ...
    "meta_io_preset_import_success": "יובאו {n} תהליכים מותאמים; דולגו {skipped}.",
    ...
    "meta_io_preset_state_existing_custom_conflict": "התנגשות עם תהליך מותאם קיים",
    "meta_io_preset_state_builtin_conflict": "התנגשות עם תהליך מובנה", "meta_io_preset_state_unsupported_schema": "סכימה לא נתמכת",
...
_TAG_EDITOR_SHELL_TEXTS_EN = {
    ...
    "meta_include_subdirs_tooltip": "Include supported audio files from nested folders on the next scan",
    "meta_shell_collapse_tree": "Collapse the file tree",
    "meta_shell_collapse_inspector": "Collapse the inspector",
    "meta_shell_tree_hint": "Use this tree to navigate and control what the table shows. Dragging an item to another folder moves it on disk immediately.",
    "meta_empty_folder_title": "No music files were found",
    "meta_empty_folder_body": "This folder contains no supported formats. Include subfolders or choose another folder.",
    "meta_show_additional_fields": "Show additional fields",
    "meta_hide_additional_fields": "Hide additional fields",
    "meta_a11y_search_scope_note": "Filters which files are listed. It does not change what Apply writes.",
    "meta_scope_hint": "Row selection is the editing scope; pending changes survive changing it",
    "meta_inspector_mode_edit": "Edit",
    "meta_shell_inspector_title": "Details",
    "meta_inspector_mode_tools": "Tools",
    "meta_inspector_mode_check": "Check",
    "meta_auto_enabled_heading": "Runs these operations",
    "meta_auto_none_enabled": "No operations are enabled yet.",
    "meta_auto_always_core": "Title and track number from filename; album from folder name — always run",
    "meta_filename_ops_note": "Each operation reads the physical filename and proposes tag values for the selected rows. Nothing is written before Apply.",
    "meta_cleanup_warn_note": "Clean-up and clear operations can remove information. Every one of them creates a reversible proposal first.",
    "meta_rename_ops_note": "Filename changes are physical, but they are held as proposals until Apply. Illegal characters, collisions and reserved names are checked before a proposal is added.",
    "meta_clean_settings_open": "Advanced clean-up settings",
    "meta_action_category_template": "Name templates",
    "meta_action_category_cleanup": "Text clean-up",
    "meta_action_category_edit": "Set a value",
    "meta_action_category_organize": "Organize",
    "meta_action_category_filename": "Filenames",
    "meta_dupes_page_note": "Scans the folder for files that look like copies of each other. Nothing is deleted without an explicit choice and confirmation.",
    "meta_dupes_never_scanned": "No duplicate scan has run for this folder yet.",
    "meta_dupes_none_found": "The last scan found no duplicates.",
    "meta_dupes_summary": "{groups} suspected groups across {files} files.",
    "meta_dupes_group_title": "{name} — {n} copies",
    "meta_dupes_reopen": "Reopen the duplicate manager",
    "meta_dupes_results_title": "Duplicates",
    "meta_dupes_results_note": "What the latest scan in this folder found. Scan again from the button above whenever needed.",
    "meta_dupes_show_results": "Show the scan results",
    "meta_dupes_rescan": "Scan this folder again",
    "meta_copy_tags": "Copy tags",
    "meta_copy_tags_hint": "Remember this file's tag values so they can be pasted onto other files.",
    "meta_paste_tags": "Paste tags",
    "meta_paste_tags_hint": "Propose the copied values for every selected file. Track number is never copied.",
    "meta_copy_tags_needs_one": "Select exactly one file to copy its tags from.",
    "meta_tag_clipboard_holds": "{n} fields copied from {name}. Track number was not copied.",
    "meta_tag_clipboard_empty_source": "That file has no tag values to copy.",
    "meta_pending_tab": "Pending Changes",
    "meta_pending_scope_note": "Apply covers every included, unblocked pending change, whatever is selected or filtered.",
    "meta_pending_summary": "{files} files changed · {applying} will be written",
    "meta_pending_none": "Nothing is waiting to be applied.",
    "meta_external_tab": "External Changes",
    "meta_external_blockers_note": "Files changed on disk since the scan stay pending and are not written until reviewed.",
    "meta_external_summary": "{stale} changed on disk · {blocked} blocking apply",
    "meta_external_none": "No external changes detected.",
    "meta_scan_error_title": "The folder could not be read",
    "meta_scan_error_retry": "Try again",
    # Footer — idle
    ...
    "meta_apply_count": "Apply {n} changes",
    "meta_pending_exclude": "Exclude this file from Apply",
    "meta_external_blocker_badge": "Blocked",
    "meta_external_review_short": "Review",
    "meta_review_subtitle": "All pending changes, their source, inclusion state and write blockers.",
    "meta_problems_preview_subtitle": "Review the proposed fix before adding it to pending changes.",
    "meta_apply_dialog_subtitle": "This is the only action that writes tags and filenames to disk.",
    "meta_apply_dialog_blocked": "{n} file(s) are blocked by external changes and will not be written.",
    "meta_apply_dialog_writes_heading": "What will be written",
    "meta_apply_dialog_files": "Files",
    "meta_apply_dialog_tag_changes": "Tag changes",
    "meta_apply_dialog_filename_changes": "Filename changes",
    "meta_apply_dialog_excluded": "Excluded",
    "meta_apply_dialog_blockers": "Blocked",
    "meta_apply_dialog_backup": "Backup",
    "meta_apply_dialog_backup_value": "Created before writing",
    "meta_apply_dialog_scope_note": "Selection and filtering do not change Apply scope. Only included, unblocked pending changes are written.",
    "meta_apply_backup_and_apply": "Create backup and apply",
    "meta_apply_result_subtitle": "A verified per-file summary of the completed Apply operation.",
    "meta_apply_result_success_title": "Apply completed",
    "meta_apply_result_partial_title": "Apply partially completed",
    "meta_apply_result_failure_title": "Apply failed",
    "meta_apply_result_success_body": "{success} files were written and verified.",
    "meta_apply_result_partial_body": "{success} completed, {partial} partial and {failed} failed. Remaining proposals stay pending.",
    "meta_apply_result_failure_body": "Writing failed. No unverified partial result is treated as complete.",
    "meta_apply_result_file": "File",
    "meta_apply_result_tags": "Tags",
    "meta_apply_result_rename": "Rename",
    "meta_apply_result_verify": "Verification",
    "meta_apply_result_not_required": "Not required",
    "meta_apply_result_rename_pending": "Still pending",
    "meta_apply_result_status_success": "Completed",
    "meta_apply_result_status_partial": "Partial",
    "meta_apply_result_status_failed": "Failed",
    "meta_apply_result_status_skipped": "Skipped",
    "meta_apply_result_status_cancelled": "Cancelled",
    "meta_apply_result_copy": "Copy details",
    "meta_apply_result_open_backups": "Open backup manager",
    "meta_apply_result_resolve_blocker": "Resolve blocker",
    "meta_move_dialog_title": "Move file or folder",
    "meta_move_dialog_subtitle": "Choose a destination inside the active library.",
    "meta_move_destination_heading": "Destination",
    "meta_move_safety_note": "Items cannot be moved outside the root, into themselves, or onto an existing item with the same name.",
    "meta_move_items_count": "{n} selected items",
    "meta_properties_dialog_subtitle": "Read-only file facts and supported capabilities.",
    "meta_property_folder": "Folder",
}
...
_TAG_EDITOR_SHELL_TEXTS_HE = {
    ...
    "meta_include_subdirs_tooltip": "כלול קובצי מוזיקה נתמכים מתיקיות פנימיות בסריקה הבאה",
    "meta_shell_collapse_tree": "קפל את עץ הקבצים",
    "meta_shell_collapse_inspector": "קפל את חלונית הפרטים",
    "meta_shell_tree_hint": "עץ זה משמש לניווט ולשליטה במה שמוצג בטבלה. גרירה לתיקייה אחרת מעבירה מיד את הפריט בדיסק.",
    "meta_empty_folder_title": "לא נמצאו קבצי מוזיקה",
    "meta_empty_folder_body": "התיקייה שנבחרה אינה מכילה פורמטים נתמכים. אפשר לכלול תתי־תיקיות או לבחור תיקייה אחרת.",
    "meta_show_additional_fields": "הצג שדות נוספים",
    "meta_hide_additional_fields": "הסתר שדות נוספים",
    "meta_a11y_search_scope_note": "מסנן אילו קבצים מוצגים. אינו משנה את מה שההחלה כותבת.",
    "meta_scope_hint": "בחירת השורות היא היקף העריכה; השינויים הממתינים נשמרים גם לאחר שינוי הבחירה",
    "meta_inspector_mode_edit": "עריכה",
    "meta_shell_inspector_title": "פרטים",
    "meta_inspector_mode_tools": "כלים",
    "meta_inspector_mode_check": "בדיקה",
    "meta_auto_enabled_heading": "מריץ את הפעולות האלה",
    "meta_auto_none_enabled": "עדיין לא הופעלה אף פעולה.",
    "meta_auto_always_core": "כותרת ומספר רצועה משם הקובץ; אלבום משם התיקייה — רצים תמיד",
    "meta_filename_ops_note": "כל פעולה קוראת את שם הקובץ הפיזי ומציעה ערכי תגיות לשורות שנבחרו. שום דבר לא נכתב לפני ההחלה.",
    "meta_cleanup_warn_note": "פעולות ניקוי ומחיקה עלולות להסיר מידע. כל אחת מהן יוצרת קודם הצעה הפיכה.",
    "meta_rename_ops_note": "שינויי שם קובץ הם פיזיים, אך הם נשמרים כהצעות עד ההחלה. תווים אסורים, התנגשויות ושמות שמורים נבדקים לפני שנוספת הצעה.",
    "meta_clean_settings_open": "הגדרות ניקוי מתקדמות",
    "meta_action_category_template": "תבניות שמות",
    "meta_action_category_cleanup": "ניקוי טקסט",
    "meta_action_category_edit": "קביעת ערך",
    "meta_action_category_organize": "ארגון",
    "meta_action_category_filename": "שמות קבצים",
    "meta_dupes_page_note": "סורק את התיקייה ומחפש קבצים שנראים כמו עותקים זה של זה. שום קובץ לא נמחק ללא בחירה מפורשת ואישור.",
    "meta_dupes_never_scanned": "עדיין לא רצה סריקת כפילויות לתיקייה הזו.",
    "meta_dupes_none_found": "הסריקה האחרונה לא מצאה כפילויות.",
    "meta_dupes_summary": "{groups} קבוצות חשודות ב־{files} קבצים.",
    "meta_dupes_group_title": "{name} — {n} עותקים",
    "meta_dupes_reopen": "פתח שוב את מנהל הכפילויות",
    "meta_dupes_results_title": "כפילויות",
    "meta_dupes_results_note": "מה שהסריקה האחרונה בתיקייה הזו מצאה. אפשר לסרוק שוב בכל עת באמצעות הכפתור למעלה.",
    "meta_dupes_show_results": "הצג את תוצאות הסריקה",
    "meta_dupes_rescan": "סרוק את התיקייה שוב",
    "meta_copy_tags": "העתק תגיות",
    "meta_copy_tags_hint": "שומר את ערכי התגיות של הקובץ הזה כדי שאפשר יהיה להדביק אותם על קבצים אחרים.",
    "meta_paste_tags": "הדבק תגיות",
    "meta_paste_tags_hint": "מציע את הערכים שהועתקו לכל הקבצים שנבחרו. מספר הרצועה לעולם אינו מועתק.",
    "meta_copy_tags_needs_one": "בחרו קובץ אחד בדיוק כדי להעתיק ממנו תגיות.",
    "meta_tag_clipboard_holds": "הועתקו {n} שדות מתוך {name}. מספר הרצועה לא הועתק.",
    "meta_tag_clipboard_empty_source": "לקובץ הזה אין ערכי תגיות להעתקה.",
    "meta_pending_tab": "שינויים ממתינים",
    "meta_pending_scope_note": "ההחלה כוללת כל שינוי ממתין שנכלל ואינו חסום, ללא תלות בבחירה או בסינון.",
    "meta_pending_summary": "{files} קבצים שונו · {applying} ייכתבו",
    "meta_pending_none": "שום שינוי אינו ממתין להחלה.",
    "meta_external_tab": "שינויים חיצוניים",
    "meta_external_blockers_note": "קבצים שהשתנו בדיסק מאז הסריקה נשארים ממתינים ואינם נכתבים עד לסקירה.",
    "meta_external_summary": "{stale} השתנו בדיסק · {blocked} חוסמים החלה",
    "meta_external_none": "לא זוהו שינויים חיצוניים.",
    "meta_scan_error_title": "לא ניתן היה לקרוא את התיקייה",
    "meta_scan_error_retry": "נסה שוב",
    # Footer — idle
    ...
    "meta_apply_count": "החל {n} שינויים",
    "meta_auto_configure_actions": "הגדר אילו פעולות ירוצו",
    "meta_artwork_choose_image": "בחר תמונה",
    "meta_artwork_proposal_note": "שינוי עטיפה יתווסף כהצעה וייכתב רק בהחלה הסופית.",
    "meta_artwork_support_note": "נתמכות עטיפות JPEG ו־PNG. קובצי GIF מונפשים אינם מוטמעים.",
    "meta_artwork_none_short": "אין עטיפה",
    "meta_artwork_mixed_short": "עטיפות שונות",
    "meta_artwork_drop_prompt": "גררו לכאן JPEG או PNG",
    "meta_lyrics_editor_note": "עורך ריק אינו מנקה מילים. ניקוי דורש פעולה מפורשת.",
    "meta_replaygain_propose_clear": "הצע ניקוי",
    "meta_replaygain_album_note": "ניתוח אלבום דורש זהות אלבום עקבית. קבצים עמומים יקבלו ערכי רצועה בלבד.",
    "meta_property_capability": "יכולת",
    "meta_property_capability_full": "תגיות + עטיפה + שינוי שם",
    "meta_property_open": "פתח",
    "meta_property_reveal": "הצג בסייר",
    "meta_property_copy_path": "העתק נתיב",
    "meta_pending_exclude": "החרג קובץ זה מההחלה",
    "meta_external_blocker_badge": "חוסם",
    "meta_external_review_short": "סקור",
    "meta_review_subtitle": "כל השינויים הממתינים, מקורם, מצב ההכללה וחסמי הכתיבה.",
    "meta_problems_preview_subtitle": "בדקו את התיקון המוצע לפני הוספתו לשינויים הממתינים.",
    "meta_apply_dialog_subtitle": "זו הפעולה היחידה שכותבת תגיות ושמות קבצים לדיסק.",
    "meta_apply_dialog_blocked": "{n} קבצים חסומים בגלל שינוי חיצוני ולא ייכתבו.",
    "meta_apply_dialog_writes_heading": "מה עומד להיכתב",
    "meta_apply_dialog_files": "קבצים",
    "meta_apply_dialog_tag_changes": "שינויי תגיות",
    "meta_apply_dialog_filename_changes": "שינויי שם",
    "meta_apply_dialog_excluded": "הוחרגו",
    "meta_apply_dialog_blockers": "חסומים",
    "meta_apply_dialog_backup": "גיבוי",
    "meta_apply_dialog_backup_value": "ייווצר לפני כתיבה",
    "meta_apply_dialog_scope_note": "בחירה וסינון בטבלה אינם משנים את היקף ההחלה. רק שינויים ממתינים שנכללו ואינם חסומים ייכתבו.",
    "meta_apply_backup_and_apply": "צור גיבוי והחל",
    "meta_apply_result_subtitle": "סיכום מאומת לכל קובץ של פעולת ההחלה שהסתיימה.",
    "meta_apply_result_success_title": "ההחלה הושלמה",
    "meta_apply_result_partial_title": "ההחלה הושלמה חלקית",
    "meta_apply_result_failure_title": "ההחלה נכשלה",
    "meta_apply_result_success_body": "{success} קבצים נכתבו ואומתו.",
    "meta_apply_result_partial_body": "{success} הושלמו, {partial} חלקיים ו־{failed} נכשלו. ההצעות שנותרו נשמרות כממתינות.",
    "meta_apply_result_failure_body": "הכתיבה נכשלה. תוצאה חלקית שלא אומתה אינה נחשבת כהצלחה.",
    "meta_apply_result_file": "קובץ",
    "meta_apply_result_tags": "תגיות",
    "meta_apply_result_rename": "שינוי שם",
    "meta_apply_result_verify": "אימות",
    "meta_apply_result_not_required": "לא נדרש",
    "meta_apply_result_rename_pending": "עדיין ממתין",
    "meta_apply_result_status_success": "הושלם",
    "meta_apply_result_status_partial": "חלקי",
    "meta_apply_result_status_failed": "נכשל",
    "meta_apply_result_status_skipped": "דולג",
    "meta_apply_result_status_cancelled": "בוטל",
    "meta_apply_result_copy": "העתק פרטים",
    "meta_apply_result_open_backups": "פתח מנהל גיבויים",
    "meta_apply_result_resolve_blocker": "פתור חסם",
    "meta_move_dialog_title": "העברת קובץ או תיקייה",
    "meta_move_dialog_subtitle": "בחרו תיקיית יעד בתוך הספרייה הפעילה.",
    "meta_move_destination_heading": "יעד",
    "meta_move_safety_note": "לא ניתן להעביר מחוץ לשורש, לתוך הפריט עצמו או ליעד שבו קיים פריט באותו שם.",
    "meta_move_items_count": "{n} פריטים שנבחרו",
    "meta_properties_dialog_subtitle": "פרטי הקובץ והיכולות הנתמכות לקריאה בלבד.",
    "meta_property_folder": "תיקייה",
}
