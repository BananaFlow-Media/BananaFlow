...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    "en": {
        ...
        "status_completed_with_preexisting": "{n} download{plural} completed ({downloaded} downloaded, {preexisting} already existed).",
    ...
    "he": {
        ...
        "status_completed_with_preexisting": "{n} הורדות הושלמו ({downloaded} הורדו, {preexisting} כבר היו קיימות).",
