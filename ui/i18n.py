...
_TAG_EDITOR_SHELL_TEXTS_EN = {
    ...
    "meta_auto_always_album": "Album from folder name — always runs",
    ...
    "meta_dupes_results_note": "What the last scan in this folder turned up. Start a new scan from Tools > Duplicate Cleanup.",
...
_TAG_EDITOR_SHELL_TEXTS_HE = {
    ...
    "meta_auto_always_album": "אלבום לפי שם התיקייה — רץ תמיד",
    ...
    "meta_dupes_results_note": "מה שהסריקה האחרונה בתיקייה הזו מצאה. סריקה חדשה מתחילים מכלים ← זיהוי וניקוי כפילויות.",
