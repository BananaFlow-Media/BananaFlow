...
Before touching the Tag Editor, read `AGENTS.md`, `docs/architecture/tag-editor-safety.md`, `docs/architecture/tag-editor-undo-rollback-guarantees.md`, `docs/architecture/tag-editor-persistence-migrations.md`, and `docs/design/tag-editor/implementation-plan.md`.
