...
- Artist-category and duplicate-review dialogs use real checkboxes with readable location labels. Exact/probable confidence and selection state are expressed in text, not by icon or color alone; the “Only …” actions remain available through keyboard focus.
