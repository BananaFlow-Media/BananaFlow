...
`artist_catalog.py` (Spotify/YTM category discovery models, stable-release
canonicalization, repeated-occurrence collapse and conservative
cross-release/category duplicate decisions),
